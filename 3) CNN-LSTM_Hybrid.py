...
plt.title("Actual vs Predicted PM2.5 (CNN-LSTM Model)")
...
plt.xlabel("Epochs")
plt.ylabel("Loss (MSE)")
plt.title("Training vs Validation Loss (CNN-LSTM Model)")
...
plt.title("Residual Plot (CNN-LSTM Model)")
...
plt.title("Error Distribution (CNN-LSTM Model)")
