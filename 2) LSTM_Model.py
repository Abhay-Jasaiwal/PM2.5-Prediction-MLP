...
station_names = [
    "ITO","Anand Vihar","Dwarka Sec 8","Jahangirpuri",
    "Mandir Marg","Okhla Phase 2","Punjabi Bagh",
    "RK Puram","Rohini","Vivek Vihar"
]
...
X_train, y_train, st_train = seq(train)
X_test, y_test, st_test = seq(test)
...
plt.title("Actual vs Predicted PM2.5 (LSTM Model)")
...
plt.title("Error Distribution (LSTM Model)")
